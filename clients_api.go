 ...
 * @return void
 */
func (a ClientsApi) DeleteV1ClientsClientId(userKey string, authorization string, clientId string) (*APIResponse, error) {
 ...
 */
func (a ClientsApi) PostV1Clients(userKey string, authorization string) (*ClientCredentials, *APIResponse, error) {
